...
\\[2pt]
\scriptsize {\lolit Slides:} \href{https://bit.ly/srop2023}{\tt \scriptsize
  \color{foreground} bit.ly/srop2023}
}
...
\frame{
  ...
  \note{These are slides for a short, informal talk that I will gave at
    Carleton College on 1 Oct 2019 and then to SROP summer students at
    UW-Madison on 13 July 2023.

    Source: {\tt https://github.com/kbroman/Talk\_SROP2023} \\
    Slides: {\tt https://bit.ly/srop2023}
}
} }
